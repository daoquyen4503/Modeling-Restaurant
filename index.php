...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/bg1.jpg">
                                ...
                                while($row=mysqli_fetch_array($query))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="dishes.php?c_id='.$row['c_id'].'">'.$row['title'].'</a></h5>
                                                    <div class="product-name">'.$row['slogan'].'</div>
                                                    <div class="price-btn-block"> <a href="dishes.php?c_id='.$row['c_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>Discover a wide range of categories from our selection of restaurants</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <p>Browse through the menu offered by the selected restaurant to find your favorite dish</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Choose your preferred delivery option and enjoy your meal! </p>
                        </div>
                    </div>
                </div>
            </div>
