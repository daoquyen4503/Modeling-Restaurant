...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link active" href="categories.php">Category <span class="sr-only"></span></a> </li>
                        <?php
    ...
    <div class="page-wrapper">
        ...
        <?php 
        $ress= mysqli_query($db,"select * from category where c_id='$_GET[c_id]'");
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                ?>
                                <div class="title-row">
                                    <?php echo $item["name"]; ?><a href="dishes.php?c_id=<?php echo $_GET['c_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>"><i class="fa fa-trash pull-right"></i></a>
                                </div>
                ...
                <div class="col-md-8">
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php  
                            $stmt = $db->prepare("SELECT * FROM dishes WHERE c_id = ?");
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                ...
                                <p>We provide the best online food ordering system, designed with care for a perfect user experience and high scalability. Order your favorite food now and get it delivered to your doorstep!</p>
                            </div>
                        </div>
                    </div>
                </div>
