...
$message = ""; // Khởi tạo biến để tránh lỗi không xác định
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        if (is_array($row)) {
            ...
            header("Location: index.php"); // Chuyển hướng ngay lập tức
            exit(); // Đảm bảo rằng không có mã nào khác được thực thi sau header
        } else {
