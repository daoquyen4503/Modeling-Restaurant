                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            //     while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    if (!mysqli_num_rows($query) > 0) {
                                                        echo '<tr><td colspan="4"><center>No Categories</center></td></tr>';
                                                    } else {
                                                        while ($row = mysqli_fetch_array($query)) {
                                                            echo '<tr>
                                                                ...
                                                                <td><div class="col-md-3 col-lg-8 m-b-10">
                                                                    <center><img src="Res_img/' . $row['image'] . '" class="img-responsive radius" style="min-width:150px;min-height:100px;"/></center>
                                                                </div></td>
                                                                <td>
                                                                    <a href="delete_restaurant.php?c_id=' . $row['c_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                                                                        <i class="fa fa-trash-o" style="font-size:16px"></i>
                                                                    </a>
                                                                    <a href="update_restaurant.php?c_id=' . $row['c_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
