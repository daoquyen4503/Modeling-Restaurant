...
if(isset($_POST['submit'])) {
    if(empty($_POST['c_name']) || empty($_POST['c_des']) || empty($_FILES['image']['name'])) {
        ...
        if($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {        
            if($fsize >= 1000000) {
                ...
                $sql = "UPDATE category SET c_name='".$c_name."', c_des='".$c_des."', image='".$fnew."' WHERE c_id='".$c_id."'";
                mysqli_query($db, $sql); 
                    ...
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    <?php
                                    $ssql = "select * from category where c_id='$_GET[c_id]'";
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input type="text" name="c_des" value="<?php echo $row['c_des']; ?>" class="form-control form-control-danger">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row p-t-20">
