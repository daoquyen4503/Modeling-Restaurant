...
<section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30"></div>
                <div class="row">
                    <?php
					...
					if (isset($_GET['title'])) {
						...
						// Kiểm tra nếu biến $name rỗng
						if (!empty($title)) {
							$sql = "SELECT * FROM dishes WHERE title LIKE '%$title%' ";
							$result = mysqli_query($db, $sql);
							...
							if ($result && mysqli_num_rows($result) > 0) {
								...
								$title = $row['title'];  
					?>
								<h1>All Results For <?php echo $row['title']; ?></h1>
					<?php
								
							} else {
								
								echo " <h2> No dishes Found </h2> ";
							}
						} else {
                            ...
                            echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="price-btn-block"> <span class="price">$'.$row['price'].'</span> <a href="dishes.php?res_id='.$row['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                        </div>
